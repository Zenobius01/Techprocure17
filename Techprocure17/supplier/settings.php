...
try {
    ...
    // Get suppliers table columns (if exists)
    try {
        $colCheck2 = $conn->query("SHOW COLUMNS FROM suppliers");
        while ($col = $colCheck2->fetch(PDO::FETCH_ASSOC)) {
            $supplier_columns[] = $col['Field'];
        }
    ...
    error_log("Profile table error: " . $e->getMessage());
}
...
try {
    // Build dynamic SELECT query for users table
    $select_fields = [];
    
    // Users table fields
    $user_fields = ['id', 'full_name', 'email', 'phone', 'address', 'city', 'region', 'postal_code', 'country', 
                    'is_active', 'created_at', 'updated_at'];
    foreach ($user_fields as $field) {
        if (in_array($field, $user_columns)) {
            if ($field === 'id') {
                $select_fields[] = "u.id as user_id";
            } elseif ($field === 'created_at') {
                $select_fields[] = "u.created_at as user_created_at";
            } else {
    ...
    if (in_array('role_name', $user_columns)) {
        $select_fields[] = "u.role_name";
    } else {
        $select_fields[] = "r.role_name";
    }
    
    // Suppliers table fields (only if supplier columns exist)
    if (!empty($supplier_columns)) {
        $supplier_fields = ['id', 'company_name', 'company_description', 'business_type', 'tin_number', 
                            'vat_registered', 'verification_status', 'website', 'facebook', 'twitter', 
                            'instagram', 'linkedin', 'bank_name', 'bank_account_name', 'bank_account_number',
                            'swift_code', 'bank_branch', 'created_at', 'updated_at'];
        foreach ($supplier_fields as $field) {
            if (in_array($field, $supplier_columns)) {
                if ($field === 'id') {
                    $select_fields[] = "s.id as supplier_id";
                } elseif ($field === 'created_at') {
                    $select_fields[] = "s.created_at as supplier_since";
                } else {
                    $select_fields[] = "s." . $field;
                }
            }
        }
    }
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action'])) {
    ...
    if (!verifyCSRFToken($submitted_token)) {
        ...
        if ($action === 'update_profile') {
            ...
            $country = sanitizeInput($_POST['country'] ?? 'Tanzania');
        ...
        // =============================================
            ...
            try {
                ...
                if (in_array('updated_at', $supplier_columns)) {
                    $update_fields[] = "updated_at = NOW()";
                }
                ...
                if (!empty($update_fields)) {
                    ...
                    if ($supplier_exists) {
                        $params[] = $supplier_id;
                        $sql = "UPDATE suppliers SET " . implode(", ", $update_fields) . " WHERE user_id = ?";
                        $update_stmt = $conn->prepare($sql);
                        $update_stmt->execute($params);
                    } else {
                        ...
                        if (in_array('created_at', $supplier_columns)) {
                        ...
                        if (!empty($insert_fields)) {
                            $sql = "INSERT INTO suppliers (" . implode(", ", $insert_fields) . ") VALUES (" . implode(", ", $insert_placeholders) . ")";
        ...
        <div class="dashboard-content">
            ...
            <div class="profile-card">
                ...
                <form method="POST" action="">
                    ...
                    <div class="row">
                        ...
                        <?php if (in_array('address', $user_columns)): ?>
                        ...
                        <?php endif; ?>
                        <?php if (in_array('city', $user_columns)): ?>
                        ...
                        <?php endif; ?>
                        <?php if (in_array('region', $user_columns)): ?>
                        <div class="col-md-3 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('postal_code', $user_columns)): ?>
                        <div class="col-md-3 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('country', $user_columns)): ?>
                        <div class="col-md-3 mb-3">
            ...
            <div class="profile-card">
                ...
                <form method="POST" action="">
                    ...
                    <div class="row">
                        <?php if (in_array('company_name', $supplier_columns)): ?>
                        <div class="col-md-6 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('business_type', $supplier_columns)): ?>
                        <div class="col-md-6 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('company_description', $supplier_columns)): ?>
                        <div class="col-md-12 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('tin_number', $supplier_columns)): ?>
                        ...
                        <?php endif; ?>
                        <?php if (in_array('vat_registered', $supplier_columns)): ?>
                        <div class="col-md-4 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('website', $supplier_columns)): ?>
                        <div class="col-md-4 mb-3">
                    ...
                    <?php if (in_array('facebook', $supplier_columns) || in_array('twitter', $supplier_columns) || in_array('instagram', $supplier_columns) || in_array('linkedin', $supplier_columns)): ?>
                    <h6 class="mt-3 mb-3">Social Media Links</h6>
                    <div class="row">
                        <?php if (in_array('facebook', $supplier_columns)): ?>
                        <div class="col-md-3 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('twitter', $supplier_columns)): ?>
                        <div class="col-md-3 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('instagram', $supplier_columns)): ?>
                        <div class="col-md-3 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('linkedin', $supplier_columns)): ?>
                        <div class="col-md-3 mb-3">
            ...
            <!-- Bank Details -->
            <?php if (!empty($supplier_columns) && (in_array('bank_name', $supplier_columns) || in_array('bank_account_name', $supplier_columns))): ?>
            <div class="profile-card">
                <div class="card-title">
                ...
                <form method="POST" action="">
                    ...
                    <div class="row">
                        <?php if (in_array('bank_name', $supplier_columns)): ?>
                        <div class="col-md-6 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('bank_branch', $supplier_columns)): ?>
                        <div class="col-md-6 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('bank_account_name', $supplier_columns)): ?>
                        <div class="col-md-6 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('bank_account_number', $supplier_columns)): ?>
                        <div class="col-md-6 mb-3">
                        ...
                        <?php endif; ?>
                        <?php if (in_array('swift_code', $supplier_columns)): ?>
                        <div class="col-md-6 mb-3">
            ...
            <div class="profile-card">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="fw-bold"><?php echo isset($supplier_data['user_created_at']) ? date('M d, Y', strtotime($supplier_data['user_created_at'])) : date('M d, Y'); ?></div>
                    </div>
                    <div class="col-md-3">
                        <div class="text-muted small">Account Status</div>
                        <div class="fw-bold">
                            <?php if (isset($supplier_data['is_active']) && $supplier_data['is_active'] == 1): ?>
